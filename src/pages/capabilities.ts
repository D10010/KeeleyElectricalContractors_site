  ...
  <div class="container">
    <div class="two-col-cap">
      ...
      <div>
        ...
        <div class="cap-list">
          <div class="cap-list__item"><svg width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="5" r="3"/><path d="m6.5 22 3.3-8.3"/><path d="m17.5 22-3.3-8.3"/><path d="M9 13.4a13 13 0 0 0 6 0"/></svg> <div><strong>Design-Assist</strong> Electrical and civil design-assist from pre-construction through completion.</div></div>
          <div class="cap-list__item"><svg width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="6" height="6" rx="1"/><path d="m3 17 2 2 4-4"/><path d="M13 6h8"/><path d="M13 12h8"/><path d="M13 18h8"/></svg> <div><strong>Project Management</strong> Dedicated project managers for scheduling, coordination, and owner communication.</div></div>
          <div class="cap-list__item"><svg width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg> <div><strong>Self-Perform</strong> In-house crews for electrical, site work, and utility scopes.</div></div>
          <div class="cap-list__item"><svg width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42"/></svg> <div><strong>6 Master Electricians</strong> Six master electricians on staff ensuring expert oversight on every project.</div></div>
          <div class="cap-list__item"><svg width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round"><circle cx="6" cy="19" r="3"/><path d="M9 19h8.5a3.5 3.5 0 0 0 0-7h-11a3.5 3.5 0 0 1 0-7H15"/><circle cx="18" cy="5" r="3"/></svg> <div><strong>Multi-State</strong> Licensed and insured to work across Maine, New Hampshire, and Massachusetts.</div></div>
        </div>
      </div>
    </div>
  </div>
